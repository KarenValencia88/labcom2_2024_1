...
# Copyright: UIS
# Description: CALCULA EL PROMEDIO DE TIEMPOS DE UNA SEÑAL EN PRESENCIA DE RUIDO
...
class PRACTICA2_RUIDO(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 60, 1, 0, 0)
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_UNIFORM, 3, 0)
