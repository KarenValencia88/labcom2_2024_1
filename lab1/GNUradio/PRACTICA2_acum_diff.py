...
import PRACTICA2_acum_diff_epy_block_0 as epy_block_0  # embedded python block
import PRACTICA2_acum_diff_epy_block_1 as epy_block_1  # embedded python block
import sip



class PRACTICA2_acum_diff(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PRACTICA2_ACUM_DIFF", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PRACTICA2_ACUM_DIFF")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PRACTICA2_acum_diff")
        ...
        self.qtgui_number_sink_1.set_title("DIFERENCIADOR")
...
def main(top_block_cls=PRACTICA2_acum_diff, options=None):
